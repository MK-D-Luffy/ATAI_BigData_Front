      ...
      <section>
        ...
        <div style="margin-right: 10%;">
          <el-form label-width="30px">
            <el-form-item class="input-prepend restyle no-radius" prop="email" :rules="[{ required: true, message: '请输入该用户的邮箱', trigger: 'blur' },{validator: checkPhone, trigger: 'blur'}]">
              <div>
                <el-input type="text" placeholder="请输入该用户的邮箱" v-model="params.mobile" />
